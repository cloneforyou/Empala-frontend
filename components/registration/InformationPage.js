...
const InformationPage = () => (
  <div className="information-container">
    <div className="information-text">
      ...
      <p className="information-text__par5">We kindly ask for your understanding with regards to our account minimums.  Empala’s minimal fees result in extremely thin operating margins<br/>
