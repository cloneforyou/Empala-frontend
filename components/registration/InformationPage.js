...
const InformationPage = (props) => (
  <div className="information-container">
    <div className="information-text">
      ...
      <p className="information-text__par1">PLEASE CAREFULLY REVIEW OUR FEES WHICH CAN BE FOUND ON OUR
        <ins>EMPALA COMMISSIONS AND FEES SCHEDULE</ins>
        PAGE.<br />
      ...
      <p className="information-text__par2">EMPALA CHARGES A FIXED ANNUAL FEE ON EACH CLIENT’S ACCOUNT.<br />
        ...
        DAILY VALUE OF THE ACCOUNT IN THE RESPECTIVE MONTH.
      </p>

      <p className="information-text__par3">THE ANNUAL FEE AT THIS TIME IS:</p>
      <p className="information-text__par4">0.25%</p>
      <p className="information-text__par5">We kindly ask for your understanding with regards to our account minimums.
